...
- All debugging and error output goes to stdout for now.  The daemons gem is configured to log stdout which gets redirected to /var/log/officer.output on OSX and Linux.
